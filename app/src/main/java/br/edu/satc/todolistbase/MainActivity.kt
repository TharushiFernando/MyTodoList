...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<FloatingActionButton>(R.id.fab).setOnClickListener {
            ...
            startActivity(Intent(this, CreateUpdateToDoItemActivity::class.java))
        }
    }
...
//        db.toDoItemDao().insertAll(toDoItem)
    ...
    private fun initRecyclerViewAdapter() {
        ...
        val itemOnDelete: (ToDoItem) -> Unit = { item ->
            toDoItemList.remove(item) // Remove o item da lista
            db.toDoItemDao().delete(item) // Exclui o item do banco de dados
        ...
        toDoItemAdapter = ToDoItemAdapter(toDoItemList, itemOnClick, itemOnChecked, itemOnDelete)
